...
# plt.show()
plt.savefig('figure/exp5/EnergyDecay_Lambda = %1.2e_n_it = %1.2e.png' % (Lambda, n_it))
plt.close(fig)
...
# plt.show()
plt.savefig('figure/exp5/FirstOrder_Lambda = %1.2e_n_it = %1.2e.png' % (Lambda, n_it))
plt.close(fig)
...
# plt.show()
plt.savefig('figure/exp5/GroundTruth.png')
plt.close(fig)
...
# plt.show()
plt.savefig('figure/exp5/LeastSquare.png')
plt.close(fig)
...
# plt.show()
plt.savefig('figure/exp5/SecondOrder_Lambda = %1.2e_n_it = %1.2e.png' % (Lambda, n_it))
plt.close(fig)