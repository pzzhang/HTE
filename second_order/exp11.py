...
# plt.show()
plt.savefig('figure/exp11/GroundTruth.png')
plt.close(fig)
...
# plt.show()
plt.savefig('figure/exp11/LeastSquare.png')
plt.close(fig)
...
# lam_min = 20
# lam_max = 300
# u_lasso_path, noise_lasso_path, uls_lasso_path = chambo2.lasso_path(lam_min=lam_min, lam_max=lam_max, nstep=40)
