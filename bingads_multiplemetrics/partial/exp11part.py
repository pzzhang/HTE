...
selectMetrics = {'OverallCountOfAdGroupOrEmbeddedSliced', 'CoreTopCountOfAdGroupOrEmbeddedSliced',
                 'CoreBottomCountOfAdGroupOrEmbeddedSliced', 'ContextRegionCountOfAdGroupOrEmbeddedSliced',
                 'OverallCoverageOfAdGroupOrEmbeddedSliced', 'CoreTopCoverageOfAdGroupOrEmbeddedSliced',
                 'CoreBottomCoverageOfAdGroupOrEmbeddedSliced', 'ContextRegionCoverageOfAdGroupOrEmbeddedSliced',
                 'OverallPageClickRateOfAdGroupOrEmbeddedSliced', 'CoreTopPageClickRateOfAdGroupOrEmbeddedSliced',
                 'CoreBottomPageClickRateOfAdGroupOrEmbeddedSliced', 'OverallClickThroughRateOfAdGroupOrEmbeddedSliced',
                 'CoreTopClickThroughRateOfAdGroupOrEmbeddedSliced', 'CoreBottomClickThroughRateOfAdGroupOrEmbeddedSliced',
                 'OverallConditionalClickRateOfAdGroupOrEmbeddedSliced', 'CoreTopConditionalClickRateOfAdGroupOrEmbeddedSliced',
                 'CoreBottomConditionalClickRateOfAdGroupOrEmbeddedSliced', 'ContextRegionConditionalClickRateOfAdGroupOrEmbeddedSliced',
                 'OverallQuickBackRateOfAdGroupSliced', 'CoreTopQuickBackRateOfAdGroupSliced'}
...
# test pure lasso
u_lasso_path, noise_lasso_path, uls_lasso_path = chambo2.lasso_path(lam_min=0.442743009321, lam_max=0.442743009321, nstep=1)
