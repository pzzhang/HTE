...
# get the marginal variance
dfmargin = pd.read_csv("../data/dt4ToteWithDelta.csv", index_col=0)
marginstd1 = np.sqrt(dfmargin["VarRDelta"].values)
marginstd1 = [marginstd1[3:], marginstd1[1:3]]
marginstd2 = [np.sqrt(VarRDelta)]

# creat an object
chambo2 = DZCKL(RDelta, 1.0/VarRDelta, marginstd=(marginstd1, marginstd2), alpha=0.5)
# chambo2 = DZCKL(RDelta, 1.0/VarRDelta, alpha=0.7)
...
# test pure lasso
u_list, uls_list, lambda_list, noise_energy_list, sol_list, dof_list, aic, bic = chambo2.lasso_path(lam_min=1.0, lam_max=70.0, nstep=400)
print "AIC : ", aic
print "BIC : ", bic
